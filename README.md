...
- Share links always receive at least a one-minute lifetime even if `email.share_token_ttl_minutes` is set to zero or a negative number; configuration loading clamps the value so mailed tokens remain usable.
