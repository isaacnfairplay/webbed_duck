...
- No new legacy modules were deprecated in this step; existing TODOs continue to call for auditing legacy compiler and server paths before future milestones.
